...
# Модель
В нашем решении присутствует две отдельных модели. Первая из них - легковесная и прямолинейная, но показывающая хорошие результаты на нашей выборке - логистическая регрессия с классификатором типа один против всех (OneVsRestClassifier) для обеспечения мульти-лейбльного предсказания по сингл-лейбльно размеченным данным.
