...
Наша модель работает с разными видами источников данных отдельно, даже если они внутри одной соц. сети. В ходе процесса предсказания они мерджатся, иногда - с учётом веса.
